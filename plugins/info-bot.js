...
🤖 ɴᴀᴍᴇ: ${namabot}
🧩 ᴠᴇʀsɪᴏɴ: 3.0.0
📚 ʟɪʙʀᴀʀʏ: ʀᴘɢ ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ ʙᴛ : ${namabot}
💻 ʀᴜɴ ᴠɪᴀ : ᴘᴀɴᴇʟ ( ʙᴜʏ ᴘᴀɴᴇʟ ᴋᴇ (( wa.me/62823504965328 ))
...
💬 ᴡʜᴀᴛsᴀᴩᴩ sᴛᴀᴛᴜs :
⮕ ${groupsIn.length} - ɢʀᴏᴜᴘ ᴄʜᴀᴛs
⮕ ${groupsIn.length} - ɢʀᴏᴜᴘ ᴊᴏɪɴᴇᴅ
⮕ ${groupsIn.length - groupsIn.length} - ɢʀᴏᴜᴘ ʟᴇғᴛ
