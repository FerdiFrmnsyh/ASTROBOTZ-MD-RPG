...
let handler = async (m, { conn, args, participants, usedPrefix, command }) => {
  ...
  let wrong = `ɢᴜɴᴀᴋᴀɴ ғᴏʀᴍᴀᴛ *${usedPrefix}${command} [ᴛʏᴘᴇ] [ᴘᴀɢᴇ]*
ᴄᴏɴᴛᴏʜ *${usedPrefix}${command} ᴍᴏɴᴇʏ 1*
...
`.trim()
  ...
  let text = `
❏› *${rpg.emoticon(type)}${type} ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅ* ‹❏
*📑 ᴘᴀɢᴇ:* ${page} ᴏғ ${getPage(type)}
*🎖️ ʏᴏᴜ:* *${userItem.indexOf(m.sender) + 1}* of *${userItem.length}*
