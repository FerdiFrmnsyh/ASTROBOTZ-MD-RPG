...
let handler = async (m, { conn, usedPrefix }) => {
   ...
   // let name = m.fromMe ? conn.user : conn.contacts[m.sender]
    ...
    let str = `
𝗜𝗡𝗩𝗘𝗡𝗧𝗢𝗥𝗬 𝗔𝗟𝗟 *${await conn.getName(name)}*

ʜᴇᴀʟᴛʜ: *${health}*
ᴀʀᴍᴏʀ: *${armor == 0 ? 'Tidak Punya' : '' || armor == 1 ? 'Leather Armor' : '' || armor == 2 ? 'Iron Armor' : '' || armor == 3 ? 'Gold Armor' : '' || armor == 4 ? 'Diamond Armor' : '' || armor == 5 ? 'Netherite Armor' : ''}*
ᴍᴏɴᴇʏ: *${money}*
ʟɪᴍɪᴛ: *${limit}*
ʟᴇᴠᴇʟ: *${level}*
ᴇxᴘ: *${exp}*
...
ʙᴀᴛᴜ: *${batu}*
ᴀǫᴜᴀ: *${aqua}*
ᴍᴀᴋᴀɴᴀɴ ᴘᴇᴛ: *${makananpet}*
ᴍᴀᴋᴀɴᴀɴ ᴘʜᴏɴɪx: *${makananphonix}*
ᴍᴀᴋᴀɴᴀɴ ɴᴀɢᴀ: *${makanannaga}*
ᴍᴀᴋᴀɴᴀɴ ɢʀɪғғɪɴ: *${makanangriffin}*
ᴍᴀᴋᴀɴᴀɴ ᴋʏᴜʙɪ: *${makanankyubi}*
ᴍᴀᴋᴀɴᴀɴ ᴄᴇɴᴛᴀᴜʀ: *${makanancentaur}*
ᴛᴏᴛᴀʟ ɪɴᴠᴇɴᴛᴏʀʏ: *${diamond + potion + ramuan + sampah + kayu + sword + iron + string + makananpet + makananphonix + makanannaga + makanangriffin + makanankyubi + makanancentaur}* item
...
*BIBIT*
ʙɪʙɪᴛ ᴍᴀɴɢɢᴀ: ${bibitmangga}
ʙɪʙɪᴛ ᴀɴɢɢᴜʀ: ${bibitanggur}
ʙɪʙɪᴛ ᴘɪsᴀɴɢ: ${bibitpisang}
ʙɪʙɪᴛ ᴊᴇʀᴜᴋ: ${bibitjeruk}
ʙɪʙɪᴛ ᴀᴘᴇʟ: ${bibitapel}
...
ʀᴜʙᴀʜ: *${rubah == 0 ? 'Tidak Punya' : '' || rubah == 1 ? 'Level 1' : '' || rubah == 2 ? 'Level 2' : '' || rubah == 3 ? 'Level 3' : '' || rubah == 4 ? 'Level 4' : '' || rubah == 5 ? 'Level MAX' : ''}*  
...
╰────────────────
╭────────────────
│ʀᴜʙᴀʜ ${rubah == 0 ? 'ᴛɪᴅᴀᴋ ᴘᴜɴʏᴀ' : '' || rubah > 0 && rubah < 5 ? `ʟᴇᴠᴇʟ *${rubah}*ᴛᴏ ʟᴇᴠᴇʟ*${rubah + 1}*\n│ᴇxᴘ *${_rubah}* -> *${rubah *1000}*` : '' || rubah == 5 ? '*ᴍᴀx ʟᴇᴠᴇʟ*' : ''}
╰────────────────
╭────────────────
│ᴋᴜᴄɪɴɢ ${kucing == 0 ? 'ᴛɪᴅᴀᴋ ᴘᴜɴʏᴀ' : '' || kucing > 0 && kucing < 5 ? `ʟᴇᴠᴇʟ *${kucing}*ᴛᴏ ʟᴇᴠᴇʟ*${kucing + 1}*\n│ᴇxᴘ *${_kucing}* -> *${kucing *1000}*` : '' || kucing == 5 ? '*ᴍᴀx ʟᴇᴠᴇʟs*' : ''}
╰────────────────
╭────────────────
