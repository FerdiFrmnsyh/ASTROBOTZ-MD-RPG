...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	await conn.sendFile(m.chat, await shortUrl(res), res, `Result From: ${text.capitalize()}`, m)
}
handler.help = handler.alias = ['downpinterest']
handler.tags = ['downloader']
handler.command = /^(downpinterest)$/i
