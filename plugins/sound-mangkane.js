...
let stiker = await sticker(null, global.API(`https://telegra.ph/file/d34b2ab2cb233c749776c.png`), global.stickpack, global.stickauth)
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'https://chat.whatsapp.com/BPBEgHoxp4VISxUlEI26lp,
    mediaType: 2, 
    description: 'https://chat.whatsapp.com/BPBEgHoxp4VISxUlEI26lp',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/1520eb940ce08a2b3e812.jpg')).buffer(),
    sourceUrl: 'https://chat.whatsapp.com/BPBEgHoxp4VISxUlEI26lp'
 	  /*   sourceUrl: sgc,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
