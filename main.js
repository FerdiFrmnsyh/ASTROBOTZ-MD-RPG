...
if (update.receivedPendingNotifications) console.log(chalk.blue('\nBot Berhasil Terhubung'))
}
...
conn.welcome = '*- - - - - -SELAMAT DATANG- - - - - -*\n⫹⫺ *Hai* @user\n⫹⫺ *SELAMAT DATANG DI GRUP :* @subject\n\n⫹⫺ *JANGAN LUPA BACA DESKRIPSI*\n@desc'
  ...
  conn.spromote = '*PROMOTE DETECT*\nSelamat @user ,Kamu Telah Menjadi admin!'
  conn.sdemote = '*DEMOTE DETECT*\n@user Sekarang Kamu Bukan Admin!'
